...
export default function Select() {
  ...
  const fetchWorkspace = (cookies) => {
    const requestOptions = {
      ...
      credentials: "include", // Change the value to 'include'
    };
  ...
  return (
    <div className="h-screen bg-[#222] flex items-center justify-center">
      <div
        className={cn(
          "bg-white px-[30px] py-[48px] rounded-3xl shadow-xl transition-all duration-300",
          isContinue ? "max-w-[750px] w-[750px]" : "max-w-[490px] w-[490px]"
        )}
      >
        ...
        <h1 className="text-3xl font-bold mt-10">
          Link your SmartLead Account
        </h1>

        {isLogin ? (
          !isContinue && (
            <p className="text-base mt-6 font-normal mb-[10px]">
              Choose a workspace
            </p>
          )
        ) : (
          <p className="text-base mt-6 font-normal">
